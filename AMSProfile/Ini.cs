...
// October 14th, 2008
// Changed the WritePrivateProfileString and GetPrivateProfileString dll calls and
// the size of the byte[] arrays used to store data from the ini files so that
// this class is able to correctly read unicode data.
...
namespace AMS.Profile
{
    ...
    public class Ini : Profile
    {
      ...
      CallingConvention = CallingConvention.StdCall)]
        ...
        {
            // Verify the section exists
            if (section == null || section.Length <= 0 || !HasSection(section))
                return null;
